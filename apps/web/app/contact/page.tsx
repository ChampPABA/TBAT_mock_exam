        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link 
                href="/" 
                className="px-4 py-2 text-gray-600 hover:text-tbat-primary transition-colors"
              >
                กลับหน้าหลัก
              </Link>
              <Link 
                href="/register" 
                className="px-4 py-2 bg-tbat-primary text-white rounded-lg hover:bg-tbat-secondary transition-colors"
              >
                สมัครสมาชิก
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-500 mt-2">เชียงใหม่, ประเทศไทย</p>
                </div>
              </div>
            </div>
          </div>
