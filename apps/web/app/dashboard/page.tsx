...
import { VVIPBadge, VVIPIndicator } from "@/components/ui/VVIPBadge"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {user.tier === 'VVIP' && <VVIPBadge size="small" />}
          ...
          <div className="px-6 py-8 sm:p-8 relative">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4">
                  <span className="text-white/70 text-sm thai-text block mb-1">ระดับสมาชิก</span>
                  <p className="font-medium text-white thai-text flex items-center">
                    {user.tier === 'VVIP' ? (
                      <span className="flex items-center">
                        <svg className="w-4 h-4 mr-1 text-yellow-300" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.969a1 1 0 00.95.69h4.172c.969 0 1.371 1.24.588 1.81l-3.379 2.456a1 1 0 00-.363 1.118l1.286 3.969c.3.922-.755 1.688-1.538 1.118l-3.379-2.456a1 1 0 00-1.176 0l-3.379 2.456c-.783.57-1.838-.196-1.538-1.118l1.286-3.969a1 1 0 00-.363-1.118L2.035 9.396c-.783-.57-.38-1.81.588-1.81h4.172a1 1 0 00.95-.69l1.286-3.969z" />
                        </svg>
                        VVIP
                      </span>
                    ) : (
