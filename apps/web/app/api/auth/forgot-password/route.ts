  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8f9fa;">
      <div style="background-color: #2563eb; color: white; padding: 20px; text-align: center;">
        <h1 style="margin: 0; font-size: 24px;">TBAT Mock Exam Platform</h1>
        <p style="margin: 5px 0 0 0; font-size: 14px;">แพลตฟอร์มสอบจำลอง TBAT</p>
      </div>
      ...
      <div style="background-color: #e5e7eb; padding: 20px; text-align: center; font-size: 12px; color: #6b7280;">
        <p style="margin: 0;">TBAT Mock Exam Platform</p>
