...
jest.mock("@/lib/rate-limit", () => ({
  rateLimit: jest.fn().mockResolvedValue(null), // No rate limit by default
  rateLimitConfigs: {
    api: {
      windowMs: 60000,
      max: 100,
...
jest.mock("@/lib/redis", () => ({
  getCachedPackageData: jest.fn().mockResolvedValue(null),
  setCachedPackageData: jest.fn().mockResolvedValue(true),
  getCachedPackageAvailability: jest.fn().mockResolvedValue(null),
  setCachedPackageAvailability: jest.fn().mockResolvedValue(true),
}));

jest.mock("@/lib/capacity", () => ({
  calculateSessionCapacity: jest.fn().mockResolvedValue({
    sessionTime: "MORNING",
